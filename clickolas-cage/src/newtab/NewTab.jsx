...
export const NewTab = () => {
  ...
  const runFlow = async (prompt) => {
    ...
    chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
      ...
      if (currentTab) {
        // Then, execute the script on the current tab
        chrome.tabs.executeScript(currentTab.id, eval('console.log("hello")'))
      }
    })
    ...
    chrome.tabs.executeScript(null, { code: codeSnippet })
